...
- **Platform facts carry a source tag — 【平台规则】 or 【经验】.** 【平台规则】 marks a hard mechanism of the platform. 【经验】 marks a creator-side observation, not an officially published statistic: use it as a rule of thumb, never quote it as data. Don't carry 公众号 instincts over to 小红书.
- **【平台规则】小红书's title cap is 20 characters, and emoji occupy character slots.** Anything past 20 is truncated by the platform, so information at the tail of the title is simply lost. **【经验】** The best range is 13–18 characters, because the cover also re-exposes the title's keywords — don't stretch for length.
...
- **【平台规则】小红书 is a search-driven community.** Besides feed distribution, a note keeps drawing traffic from search and from recommendations shown after a search. A title with no word a user would type into the search box gives up that long tail — a weight far above 公众号's. **【经验】** One well-aimed search term beats three stacked keywords: spend the budget writing one main term in full (`油皮粉底液`, not `美妆 好物 粉底 推荐`). Keyword stacking is also judged as marketing behavior.
