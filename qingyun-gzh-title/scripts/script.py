#!/usr/bin/env python3
"""Main script for the qingyun-gzh-title skill: runs both mechanical gates in one pass.
...
def check(title):
    ...
    if m["verdict"] == "FAIL" or hard_compliance:
        verdict = "FAIL"
    elif compliance or m["emoji_note"]:
        verdict = "WARN"
    else:
        verdict = "PASS"
...
def main():
    ap = argparse.ArgumentParser(
        description="qingyun-gzh-title gates: length / compliance")
